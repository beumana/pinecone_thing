...
class DealersControllerTest < ActionController::TestCase
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post :create, dealer: { description: @dealer.description, name: @dealer.name, state: @dealer.state, zone: @dealer.zone }
    end
  ...
  test "should update dealer" do
    patch :update, id: @dealer, dealer: { description: @dealer.description, name: @dealer.name, state: @dealer.state, zone: @dealer.zone }
    assert_redirected_to dealer_path(assigns(:dealer))
  end
